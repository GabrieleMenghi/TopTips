...
<?php foreach($templateParams["notifiche"] as $notifica): ?>
    <div class="col-12 my-1">
        <div class="d-flex justify-content-center align-items-center">
            ...
            <div class="col-2">    
                <i class="bx bx-trash" idnotify="<?php echo $notifica["idnotifica"];?>" onclick="deleteNotify()"></i>
            </div>
        </div>
    </div>
<?php endforeach; ?>
...
<script type="text/javascript">
    ...
    function deleteNotify(){
        const btntrash = document.querySelector('.bx-trash');
        var xhttp = new XMLHttpRequest();
        let parameters = "idnotifica=" + btntrash.getAttribute('idnotify');
